...
SELECT DISTINCT player FROM game JOIN goal ON matchid = id WHERE (team2='GER' OR team1='GER') AND  teamid != 'GER'
...
SELECT matchid, mdate, COUNT(gtime) FROM game JOIN goal ON matchid=id WHERE (team1='GER' OR team2='GER') AND teamid = 'GER' GROUP BY matchid, mdate
